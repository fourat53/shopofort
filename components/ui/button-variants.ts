...
export const buttonVariants = cva(
	"group/button border-2 inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-xs/relaxed font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 shadow-[0px_0px_4px_0.5px_rgba(20,38,41,0.5)]",
	{
		variants: {
			variant: {
				default:
				...
				outline:
					"bg-foreground/90 dark:bg-sidebar-accent border-mist-50 text-mist-50 hover:bg-chart-4 hover:dark:bg-muted-foreground hover:dark:text-mist-800",
				ghost:
