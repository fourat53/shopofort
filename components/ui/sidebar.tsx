...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
	...
	return (
		<main
			...
			className={cn(
				"p-2 rounded-l-4xl bg-sidebar relative flex w-full flex-1 flex-col md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2",
