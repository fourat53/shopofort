...
function TableHead({
	...
	return (
		<th
			...
			className={cn(
				"h-7 py-1.5 px-2.5 font-semibold whitespace-nowrap text-foreground has-[[role=checkbox]]:pr-0",
...
function TableCell({
	...
	return (
		<td
			...
			className={cn(
				"h-8.5 p-2 align-middle whitespace-nowrap has-[[role=checkbox]]:pr-0",
				border && "border-l",
				className,
			)}
			{...props}
